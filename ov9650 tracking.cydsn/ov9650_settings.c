...
const unsigned char ov9650_settings[][2] = {
	...
	{ REG_GAIN, 0x00 },  //analogue gain
	{ REG_BLUE, 0x80 },  //blue channel analogue gain
	{ REG_RED, 0x80 },   //red channel analogue gain
	{ REG_COM1, 0x00 },  //exposure time 2 LSB
	{ REG_AECH, 0x0a },  //exposure time
	{ REG_AECHM, 0x00 }, //exposure time
//	{ REG_EXHCL, 0x10 },  //dummy pixels per line
	{ 0xff,0xff }
};

const unsigned char ov9650_format_regs[] = {
	0x12, 0x0c, 0x0d, 0x17, 0x18, 0x32, 0x19, 0x1a, 0x03,
	0x37, 0x38, 0x39,0xff
};

const unsigned char ov9650_sxga_settings[] = {
	0x00, 0x00, 0x00, 0x1d, 0xbd, 0xbf, 0x01, 0x81, 0x12,
	0x81, 0x93, 0x51,
};

const unsigned char ov9650_vga_settings[] = {
	0x40, 0x04, 0x80, 0x26, 0xc6, 0xed, 0x01, 0x3d, 0x00,
	0x91, 0x12, 0x43,
};

const unsigned char ov9650_qvga_settings[] = {
	0x10, 0x04, 0x80, 0x26, 0xc6, 0xed, 0x00, 0x1e, 0x36,
	0x91, 0x12, 0x43,
};

const unsigned char ov9650_cif_settings[] = {
	0x20, 0x04, 0x80, 0x28, 0x80, 0xed, 0x00, 0x24, 0x36,
	0x91, 0x12, 0x43,
};

const unsigned char ov9650_qcif_settings[] = {
