...
static struct
{
	...
	{
		SPI_nrf_WriteTxData(tx);
	    while(!SPI_nrf_GetRxBufferSize());
	    return SPI_nrf_ReadRxData();
	}
} _SPI;
...
bool RF24::setDataRate(rf24_datarate_e speed)
{
  ...
  #if defined(__arm__) || defined (RF24_LINUX) || defined (__ARDUINO_X86__) || defined (CY_PSOC5)
    txRxDelay=250;
  #else //16Mhz Arduino
    txRxDelay=85;
  #endif
